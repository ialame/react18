...
export default class CardList extends React.Component {
    ...
    componentDidMount() {
        axios.get(`http://localhost:8090/repeter`)
            .then(res => {
                                                        ...
                                                        <div className="card-body">
                                                            <div className="row align-items-center d-flex justify-content-around">
                                                                ...
                                                                <div className="col-md-4">
                                                                    <img src={card.image} alt="" className="img-fluid candidate-img"/>
                                                                ...
                                                                <div className="col-md-7">
                                                                    <ul className="list-group">
                                                                        ...
                                                                        <li className="list-group-item list-group-item-action">
                                                                            Email: <span className="fw-bold">{card.email}</span>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                                <div className="col-md-1 d-flex flex-column align-items-center">

                                                                    <Link to={`/card/view/${card.id}`} className="btn btn-warning my-1">
                                                                        <i className="fa fa-eye"></i>
                                                                    </Link>
                                                                    <Link to={`/candidate/edit/${card.id}`} className="btn  btn-primary my-1">
